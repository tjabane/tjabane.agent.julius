...
class InvestecClient:
    def __init__(
        ...
        base_url = base_url or get_investec_base_url()
    ...
    def transfer_funds(
        ...
        return self.payments.transfer_funds(
            account_id=account_id,
            transfers=transfers,
    ...
    def pay_beneficiaries(self, account_id: str, payments: list[dict[str, Any]]) -> list[dict[str, Any]]:
        return self.payments.pay_beneficiaries(account_id=account_id, payments=payments)

    def get_documents(self, account_id: str, from_date: str, to_date: str) -> list[dict[str, Any]]:
        return self.documents.get_documents(account_id=account_id, from_date=from_date, to_date=to_date)
